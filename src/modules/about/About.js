                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.section}>
                        <Button iconLeft onPress={() => Linking.openURL('https://studentersamfundet.no/aapningstider/')}>
                            <Icon name="time" style={styles.icon} /><NBText>Vis Åpningstider</NBText>
                        </Button>
                    </View>
                    ...
                    <View style={[styles.section, {flex: 1, flexDirection: 'row'}]}>
                        ...
                        <Button iconLeft onPress={() => Linking.openURL('tel:+4794430002')} style={{marginHorizontal: 10}}>
                            <Icon name="call" style={styles.icon} /><NBText>Ring</NBText>
                        </Button>
                        </View>
                        <View>
                        <Button iconLeft onPress={() => Linking.openURL('mailto:ledelsen@studentersamfundet.no')} style={{marginHorizontal: 10}}>
                            <Icon name="mail" style={styles.icon} /><NBText>Send e-post</NBText>
                        </Button>
                        </View>
                    </View>
